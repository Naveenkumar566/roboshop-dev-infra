...
resource "aws_acm_certificate" "roboshop" {                                                                #cretificate creation
...
resource "aws_route53_record" "roboshop" {                                                                 #create rcords
  for_each = {
...
resource "aws_acm_certificate_validation" "roboshop" {                                                     #validation
